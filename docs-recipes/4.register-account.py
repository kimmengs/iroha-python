...
new_account_id = "ed01206EA0DD4252E4EAE48F60159CE2DBDAA5F324B34C09840CC0897FCD27DD47FED4@hivefund"

accounts = client.query_all_accounts_in_domain("hivefund")
...
if new_account_id in accounts:
    print("'ed01206EA0DD4252E4EAE48F60159CE2DBDAA5F324B34C09840CC0897FCD27DD47FED4@hivefund' domain already exists.")
...
print("Listing all accounts in hivefund...")
for a in accounts:
    print(" - ", a,)